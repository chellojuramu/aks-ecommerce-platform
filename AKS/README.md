...
<create_file>
<path>/mnt/user-data/outputs/ROOT-README.md</path>
<description>Root README for repository</description>
<content># AKS E-Commerce Platform

[![Kubernetes](https://img.shields.io/badge/Kubernetes-1.28+-326CE5?logo=kubernetes&logoColor=white)](https://kubernetes.io/)
[![Helm](https://img.shields.io/badge/Helm-3.0+-0F1689?logo=helm&logoColor=white)](https://helm.sh/)
[![Azure](https://img.shields.io/badge/Azure-AKS-0089D6?logo=microsoftazure&logoColor=white)](https://azure.microsoft.com/en-us/services/kubernetes-service/)

> **Production-grade microservices e-commerce platform on Azure Kubernetes Service**

Multi-tier application with 10 services (Node.js, Python, Java, nginx) deployed using Helm charts on AKS with Azure Application Gateway Ingress.

---

## 🚀 Quick Links

- **[📖 Full Documentation](./AKS/README.md)** - Complete setup guide
- **[🎯 Helm Chart](./AKS/helm/)** - Production-ready Helm charts
- **[🏗 Architecture](./AKS/README.md#-architecture)** - System design
- **[⚡ Quick Start](./AKS/README.md#-quick-start)** - Deploy in 5 minutes
...
**Deployment:**
- Azure Kubernetes Service (AKS)
- Helm 3 for orchestration
- Azure Application Gateway Ingress Controller
- Production-grade resource limits & health probes

---

## ✨ Features

✅ Complete Helm chart with 900+ configurable parameters  
✅ StatefulSets for databases (MongoDB, Redis)  
✅ Secrets management (MySQL, RabbitMQ)  
...
**📖 [Read the full documentation](./AKS/README.md) for detailed instructions.**
...
```
aks-ecommerce-platform/
├── AKS/
│   ├── helm/                    # Helm chart (main deployment)
│   │   ├── Chart.yaml
│   │   ├── values.yaml
│   │   └── templates/
│   │       ├── catalogue.yaml
...
│   │       ├── rabbitmq.yaml
│   │       └── ingress.yaml
│   ├── create-aks.sh           # Cluster creation script
│   ├── delete-aks.sh           # Cleanup script
│   └── README.md               # Full documentation
├── cart/                        # Individual service manifests
├── catalogue/
├── user/
├── payment/
├── shipping/
...
**Application:** Node.js, Python, Java, nginx  
...
**📧 Connect with me:**  
💼 [LinkedIn](https://www.linkedin.com/in/ramuchelloju/) - Let's connect!  
🐙 [GitHub](https://github.com/chellojuramu) - Follow for more projects  
